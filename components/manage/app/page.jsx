...
const AppSettings = () => {
   ...
   const [addAppSettings, { data, isSuccess, isError }] =
      useAddAppSettingsMutation();
   ...
   }, [isUpdatedSuccess, isUpdatedError, toast]);
   ...
   }, [isDataFetchedSuccess, isDataFetchedError, toast]);
                     ...
                     <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                        ...
                        <div className='col-span-2 lg:col-span-1'>
                           <Input
                              ...
                              register={register}
                              errors={errors}
                              defaultValue={finalFetchedData?.one_signal_app_id}
                              setValue={setValue}
                           />
                        </div>
                        <div className='col-span-2 lg:col-span-1'>
                     ...
                     <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                        ...
                        <div className='col-span-2 lg:col-span-1'>
                           <Input
                              ...
                              register={register}
                              errors={errors}
                              defaultValue={finalFetchedData?.firebase_topics}
                              setValue={setValue}
                           />
                        </div>
                     </div>
                           ...
                           <div className='grid grid-cols-2 gap-6 shadow-gray-500'>
                              ...
                              <div className='col-span-2 lg:col-span-1'>
                                 <Input
                                    ...
                                    errors={errors}
                                    defaultValue={
                                       finalFetchedData?.ios_settings?.app_url
                                    }
                                    setValue={setValue}
                                 />
                              </div>
